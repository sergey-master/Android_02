...
public class MyActivity extends Activity
    ...
    public void goAnimation(View view) {
        Intent intent = new Intent(this, FadeInActivity.class);
    ...
    public void onSectionAttached(int number) {
        ...
        switch (number) {
            case 1:
                ...
                commitFragment(new Screen1(), getFragmentManager());
                break;
            case 2:
                mTitle = getString(R.string.title_section2);
                commitFragment(new Screen2(), getFragmentManager());
                break;
            case 3:
                mTitle = getString(R.string.title_section3);
                commitFragment(new Screen3(), getFragmentManager());
                break;
        }
    }
